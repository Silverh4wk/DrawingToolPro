Changes made for our second chance:
- changed to jscrollpane for both canvases and now we can scroll left/right or up/down if the sizes were too big for the screen to hold.
- added the saving options from jpg to png, with error handling if lets say the user wanted to save to the wrong extension.
